...
import io.viper.android.todolist.todolist.Injection;
import io.lhyz.android.todolist.R;
import io.viper.android.todolist.todolist.statistics.StatisticsActivity;
import io.viper.android.todolist.todolist.util.ActivityUtils;
        ...
        navigationView.setNavigationItemSelectedListener(
                new NavigationView.OnNavigationItemSelectedListener() {
                    ...
                    public boolean onNavigationItemSelected(MenuItem menuItem) {
                        ...
                        if (itemId == R.id.statistics_navigation_menu_item) {
                            Intent intent =
                                    new Intent(TasksActivity.this, StatisticsActivity.class);
                            intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK
                                    | Intent.FLAG_ACTIVITY_CLEAR_TASK);
                            startActivity(intent);
                        } else if (itemId == R.id.list_navigation_menu_item) {
